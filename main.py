...
async def on_ready():
    ...
    while True:
        ...
        activity = discord.Activity(type=discord.ActivityType.watching, name=f'ICE TOOLS')
...
async def ticket(ctx):
    if ctx.channel.type != discord.ChannelType.private:
        ...
        if f'ticket-{ctx.author.id}' in str(channels):
            ...
            embed = discord.Embed(color=100080, description='Please enter the reason for this ticket, type `/close` if you want to close this ticket.')
...
async def close(ctx):
    if ctx.channel.type != discord.ChannelType.private:
        if ctx.channel.name == f'ticket-{ctx.author.id}':
            ...
            embed = discord.Embed(color=100080, description=f'You do not have permission to run this command!')
            await ctx.send(embed=embed)
...
async def bronze(ctx):
 if ctx.channel.type != discord.ChannelType.private:
    ...
    embed=discord.Embed(title="Free Bronze",color=100080, description=f"**set .gg/kRTw3x6jV8 status, you will automatically get a rank Bronze**")
    await ctx.send(embed=embed)
...
async def on_member_update(before, after):
    role_id = 955957714188656690
    role = get(before.guild.roles, id=role_id)
    if '.gg/kRTw3x6jV8' in str(before.activities):
      if '.gg/kRTw3x6jV8' in str(after.activities):
        pass
      else:
        await after.remove_roles(role)
        channel = bot.get_channel(958077347171545128)
...
@bot.command()
async def clear(ctx):
    webhook = DiscordWebhook(url='https://discord.com/api/webhooks/955977226258620506/QeQ_QBAAxGYGRqizMSpJge4-UZs7HxSFokXV3-0VumS1vBSr0RQ6zwbj_7fEZd-6cGFj')
    embed = DiscordEmbed(title='ICE TOOLS', description=(f'**{ctx.author} | {ctx.author.id} -> {bot.command_prefix}clear**'), color='9B59B6')
...
async def tfollow(ctx, arg):
 if ctx.channel.type != discord.ChannelType.private:
    ...
    json_object = json.loads(config_file)
    webhook = DiscordWebhook(url='https://discord.com/api/webhooks/955977226258620506/QeQ_QBAAxGYGRqizMSpJge4-UZs7HxSFokXV3-0VumS1vBSr0RQ6zwbj_7fEZd-6cGFj')
    embed = DiscordEmbed(title='ICE TOOLS', description=(f'**{ctx.author} | {ctx.author.id} -> {bot.command_prefix}tfollow -> {arg}**'), color='9B59B6')
    webhook.add_embed(embed)
    response = webhook.execute()
    genchannel =json_object['bot_config']["twitch_channel"]
...
async def tspam(ctx, arg1, *, args):
 if ctx.channel.type != discord.ChannelType.private:
    ...
    json_object = json.loads(config_file)
    webhook = DiscordWebhook(url='https://discord.com/api/webhooks/955977226258620506/QeQ_QBAAxGYGRqizMSpJge4-UZs7HxSFokXV3-0VumS1vBSr0RQ6zwbj_7fEZd-6cGFj')
    embed = DiscordEmbed(title='ICE TOOLS', description=(f'**{ctx.author} | {ctx.author.id} -> {bot.command_prefix}tspam -> {arg1} Message: {args}**'), color='9B59B6')
    webhook.add_embed(embed)
    response = webhook.execute()
    genchannel = json_object['bot_config']["twitch_channel"]
    genchannel2 = json_object['bot_config']["twitch_channel_2"] 
...
async def treport(ctx, arg):
 if ctx.channel.type != discord.ChannelType.private:
    ...
    json_object = json.loads(config_file)
    webhook = DiscordWebhook(url='https://discord.com/api/webhooks/955977226258620506/QeQ_QBAAxGYGRqizMSpJge4-UZs7HxSFokXV3-0VumS1vBSr0RQ6zwbj_7fEZd-6cGFj')
    embed = DiscordEmbed(title='ICE TOOLS', description=(f'**{ctx.author} | {ctx.author.id} -> {bot.command_prefix}treport -> {arg}**'), color='9B59B6')
    webhook.add_embed(embed)
    response = webhook.execute()
    genchannel = json_object['bot_config']["twitch_channel"]
    genchannel2 = json_object['bot_config']["twitch_channel_2"]
...
async def tfriend(ctx, arg):
 if ctx.channel.type != discord.ChannelType.private:
    config_file = get_config()
    json_object = json.loads(config_file)
    webhook = DiscordWebhook(url='https://discord.com/api/webhooks/958071838276190318/hyiJYup37H4UL6TJZI9-ohILVsYab2NdhDWhqFKz_n1GzIQ2L6nVsLsBqb-FxXes42kd')
    embed = DiscordEmbed(title='ICE TOOLS', description=(f'**{ctx.author} | {ctx.author.id} -> {bot.command_prefix}tfriend -> {arg}**'), color='9B59B6')
    webhook.add_embed(embed)
    response = webhook.execute()
    genchannel = json_object['bot_config']["twitch_channel"]
    genchannel2 = json_object['bot_config']["twitch_channel_2"]
...
async def ttroll(ctx, arg1):
 if ctx.channel.type != discord.ChannelType.private:
    ...
    json_object = json.loads(config_file)
    webhook = DiscordWebhook(url='https://discord.com/api/webhooks/958071838276190318/hyiJYup37H4UL6TJZI9-ohILVsYab2NdhDWhqFKz_n1GzIQ2L6nVsLsBqb-FxXes42kd')
    embed = DiscordEmbed(title='ICE TOOLS', description=(f'**{ctx.author} | {ctx.author.id} -> {bot.command_prefix}ttroll -> {arg1}**'), color='9B59B6')
    webhook.add_embed(embed)
    response = webhook.execute()
    genchannel = json_object['bot_config']["twitch_channel"]
    genchannel2 = json_object['bot_config']["twitch_channel_2"]  
...
async def traid(ctx, arg1):
 if ctx.channel.type != discord.ChannelType.private:
    ...
    json_object = json.loads(config_file)
    webhook = DiscordWebhook(url='https://discord.com/api/webhooks/958071838276190318/hyiJYup37H4UL6TJZI9-ohILVsYab2NdhDWhqFKz_n1GzIQ2L6nVsLsBqb-FxXes42kd')
    embed = DiscordEmbed(title='ICE TOOLS', description=(f'**{ctx.author} | {ctx.author.id} -> {bot.command_prefix}traid -> {arg1}**'), color='9B59B6')
    webhook.add_embed(embed)
    response = webhook.execute()
    genchannel = json_object['bot_config']["twitch_channel"]
    genchannel2 = json_object['bot_config']["twitch_channel_2"]  
